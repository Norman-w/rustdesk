...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("macos_tcc_title", "macOS 权限检查"),
        ("macos_tcc_tip", "为了让手机正常看到画面并控制这台电脑，请在 macOS 的“屏幕录制”“辅助功能”和“输入监控”中允许 NormanRemoteDesktop。重新编译或重新安装后，可点击此处再次检查并修复。"),
        ("macos_tcc_repair", "检查并修复"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
