...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("macos_tcc_title", "macOS permission check"),
        ("macos_tcc_tip", "To let NormanRemoteDesktop show and control this Mac, allow Screen Recording, Accessibility, and Input Monitoring. After rebuilding or reinstalling, use this button to check and repair permissions again."),
        ("macos_tcc_repair", "Check and repair"),
